...
// CSP CORRIGÉE pour Paystack :
// - script-src: Ajout de 'unsafe-inline' pour les gestionnaires d'événements inline si nécessaire, et https://js.paystack.co pour le script Paystack.
// - style-src: Ajout de https://paystack.com pour les styles de Paystack.
// - img-src: Ajout de https://*.paystack.com pour les images de Paystack.
// - frame-src: Ajout de 'self' et https://checkout.paystack.com pour l'iframe de paiement.
// - connect-src: Autorise les connexions à l'API Paystack.
// - form-action: Autorise la soumission de formulaires vers Paystack.
$csp_directives = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' https://js.paystack.co",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://paystack.com",
    "font-src 'self' https://fonts.gstatic.com",
    "img-src 'self' data: blob: https://*.paystack.com", // Ajout de blob: pour les aperçus d'images locales
